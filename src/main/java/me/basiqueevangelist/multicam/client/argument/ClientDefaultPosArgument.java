...
public class ClientDefaultPosArgument implements ClientPosArgument {
    ...
    public static ClientDefaultPosArgument absolute(Vec2f vec) {
        return new ClientDefaultPosArgument(new CoordinateArgument(false, vec.x), new CoordinateArgument(false, vec.y), new CoordinateArgument(true, 0.0));
    }

    public static ClientDefaultPosArgument zero() {
        return new ClientDefaultPosArgument(new CoordinateArgument(true, 0.0), new CoordinateArgument(true, 0.0), new CoordinateArgument(true, 0.0));
    }
